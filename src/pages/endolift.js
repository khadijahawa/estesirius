...
export default function Endolift() {
  ...
  return (
    <>
      <Head>
        <title>تقنية اندوليفت | شد الوجه بدون جراحة</title>
        <meta name="description" content="تقنية اندوليفت - علاج شد الوجه بدون جراحة مع نتائج فورية تدوم ٥ سنوات." />
      </Head>

      <div className="endolift-page" style={{ direction: 'rtl' }}>
        {/* Promo Banner - Top */}
        <a 
          href="https://wa.link/7gjnrj" 
          target="_blank" 
          rel="noopener noreferrer"
          className="bg-gradient-to-r from-red-600 to-purple-500 text-white py-3 px-4 text-center font-bold flex flex-row-reverse items-center justify-center hover:opacity-90 transition duration-300"
        >
          <span className="text-lg md:text-xl text-right">خصم ٢٠٪ لأول ١٠ حجوزات عبر واتساب</span>
          <FaWhatsapp className="mr-3 ml-0 text-3xl md:text-4xl" />
        </a>
        ...
        <div className="bg-gradient-to-b from-sky-50 to-white">
          <div className="container mx-auto px-4 py-8 text-center">
            ...
            <div className="rounded-lg p-6 mb-8 max-w-xs mx-auto md:max-w-md lg:max-w-lg xl:max-w-2xl">
              <ul className="space-y-5 md:space-y-6 w-full">
                <li className="flex flex-row items-center w-full">
                  <div className="bg-secondary-dark w-10 h-10 md:w-12 md:h-12 rounded-full flex items-center justify-center flex-shrink-0 ml-4">
                    <FaCheck className="text-white text-lg md:text-xl" />
                  </div>
                  <span className="font-medium text-lg md:text-xl lg:text-2xl w-full text-right">بدون جراحة تماماً</span>
                </li>
                <li className="flex flex-row items-center w-full">
                  <div className="bg-secondary-dark w-10 h-10 md:w-12 md:h-12 rounded-full flex items-center justify-center flex-shrink-0 ml-4">
                    <FaCheck className="text-white text-lg md:text-xl" />
                  </div>
                  <span className="font-medium text-lg md:text-xl lg:text-2xl w-full text-right">جلسة واحدة فقط</span>
                </li>
                <li className="flex flex-row items-center w-full">
                  <div className="bg-secondary-dark w-10 h-10 md:w-12 md:h-12 rounded-full flex items-center justify-center flex-shrink-0 ml-4">
                    <FaCheck className="text-white text-lg md:text-xl" />
                  </div>
                  <span className="font-medium text-lg md:text-xl lg:text-2xl w-full text-right">نتائج فورية</span>
                </li>
                <li className="flex flex-row items-center w-full">
                  <div className="bg-secondary-dark w-10 h-10 md:w-12 md:h-12 rounded-full flex items-center justify-center flex-shrink-0 ml-4">
                    <FaCheck className="text-white text-lg md:text-xl" />
                  </div>
                  <span className="font-medium text-lg md:text-xl lg:text-2xl w-full text-right">تدوم لمدة ٥ سنوات</span>
                </li>
              </ul>
            </div>
            ...
            >
              <FaWhatsapp className="mr-0 ml-3 text-4xl" />
              <span>انقر للحصول على استشارة مجانية عبر واتساب</span>
            </a>
          </div>
        </div>
        ...
        <div className="py-10 bg-white">
          <div className="container mx-auto px-4">
            ...
            <div className="space-y-4 max-w-xs mx-auto mb-10 md:max-w-sm lg:max-w-md xl:max-w-lg">
              <div className="bg-teal-100 rounded-lg p-4 flex flex-row items-center">
                <RiMedicineBottleLine className="text-2xl text-teal-600 flex-shrink-0 ml-4" />
                <p className="font-medium text-lg md:text-xl w-full text-right">بدون أي ألم</p>
              </div>
              <div className="bg-teal-100 rounded-lg p-4 flex flex-row items-center">
                <FaClock className="text-2xl text-teal-600 flex-shrink-0 ml-4" />
                <p className="font-medium text-lg md:text-xl w-full text-right">تستغرق نصف ساعة</p>
              </div>
              <div className="bg-teal-100 rounded-lg p-4 flex flex-row items-center">
                <FaMoneyBillWave className="text-2xl text-teal-600 flex-shrink-0 ml-4" />
                <p className="font-medium text-lg md:text-xl w-full text-right">أرخص من الجراحة</p>
              </div>
            </div>
        ...
        <div className="py-10 bg-gray-50">
          <div className="container mx-auto px-4">
            <h2 className="text-xl md:text-2xl lg:text-3xl font-bold text-center mb-4 text-secondary-dark">
              اسمع من عملائنا <br />
              <span className="bg-secondary-dark text-white px-3 py-1 rounded-lg inline-block mt-2">وليس منا</span>
            </h2>
...
// Hide the default footer for this page
Endolift.hideFooter = true;
