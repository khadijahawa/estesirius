    ...
    <div className="py-20 bg-white font-sans">
      <div className="container mx-auto px-4">
        ...
        <div className="max-w-4xl mx-auto">
          <p className="text-lg text-gray-dark mb-8 text-center">
          ...
          <div className="grid md:grid-cols-3 gap-8 text-center">
            <div>
              <div className="bg-gray-light rounded-full w-20 h-20 flex items-center justify-center mx-auto mb-4">
                <span className="text-primary text-3xl font-bold">1</span>
              </div>
              <h3 className="font-bold mb-2">Expert Team</h3>
              <p className="text-gray-dark">Board-certified specialists with years of experience in aesthetic procedures.</p>
            </div>
            <div>
              <div className="bg-gray-light rounded-full w-20 h-20 flex items-center justify-center mx-auto mb-4">
              ...
              <p className="text-gray-dark">State-of-the-art equipment and cutting-edge procedures for optimal results.</p>
            </div>
            <div>
              <div className="bg-gray-light rounded-full w-20 h-20 flex items-center justify-center mx-auto mb-4">
              ...
              <p className="text-gray-dark">Custom treatment plans tailored to your individual needs and goals.</p>
            </div>
          </div>
        </div>
      </div>
